...
export const LORDICON_URLS = {
  ...
  document: 'https://cdn.lordicon.com/ujxzdfjx.json',
  ...
  check: 'https://cdn.lordicon.com/egiwmiit.json',
  clock: 'https://cdn.lordicon.com/abfverha.json',
  ...
  download: 'https://cdn.lordicon.com/albqovim.json',
